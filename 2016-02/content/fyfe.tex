...
\begin{document}
	...
	\marginnote{Developing the Model}
...
\end{enumerate}
	...
	\begin{figure}[!htb] %TABLE 1
		...
		\captionof{table}{Aims of the non-academic skills development model (Copyright to authors).}
		\centering
	...
	\marginnote{Case Study One: \emph{Canning Mills}}
	...
	\marginnote{Evaluating the Process}
	...
	\marginnote{Case Study Two: \emph{Statham's Quarry}}
