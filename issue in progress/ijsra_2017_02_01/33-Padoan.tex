...
\def\cmail{amanda.padoan@pepperdine.edu}
\def\keywords{Gender Archeology, Cahokia, Mound 72, Birdman, Sophia Schliemann, La Doncella, Lalita Tati, human sacrifice}
%\def\keywordname{}%<--- redefine the name “Keywords“ in needed language
\def\abstract{}
%--------Author’s names------------
\def\authorone{Amanda Padoan}
%-------Biographical information-------------
\def\bioone{Amanda Padoan is an MPhil student in Multi-disciplinary Gender Studies at University of Cambridge, where she holds the designation of Bell Scholar. She also teaches at Pepperdine University School of Law.}
%------University/Institution--------------
\def\affilone{MPhil student, University of Cambridge}
...
%Not directly cited, but supplementary references -- Lukas:
...
\begin{figure}[!htb]
	\includegraphics[width=\linewidth]{33-Padoan-figure02}
	\caption{Sophia Schliemann}.
		{\normalfont\scriptsize \\ Image is in the public domain. Accessed from https://en.wikipedia.org/wiki/Heinrich_Schliemann#/media/File:Sophia_schliemann_treasure.jpg.
	}}
	\label{fig:33-Padoan-figure01}
\end{figure}
