...
\begin{figure}[!p]
	...
	\captionof{table}{Adapted from the description of political prisoner’s meals by Michael Dingake in Hutton (1997:54).
	}
...
%FIG 8
\begin{figure}[!p]
	\includegraphics[width=.5\linewidth]{Mwaita_Figure_08}
