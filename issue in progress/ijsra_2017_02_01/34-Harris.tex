...
\def\biotwo{Danielle Croucher is a MSt student at UCL's Institute of Archaeology, studying archaeologicla skeletal remains.}%<---- comment or delete if there is no second author.
\def\biothree{Hayden McKee is also a MSt student at UCL's Institute of Archaeology, studying archaeologicla skeletal remains.}%<---- comment or delete if there is no third author.
