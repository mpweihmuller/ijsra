...
\begin{figure}[!htb]
	\begin{minipage}[b]{0.55\linewidth}
		...
		\caption{Cross sections of Beech wood (\emph{Fagus sylvatica L.}) on light microscope (a) standard from \textcite{Richter_2000}, (b) sample taken from the handle of the gun (\SI{20}{\micro\metre}).}
		\label{fig:Fig8}
	\end{minipage} 
