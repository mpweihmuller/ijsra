...
%fig.1
 \begin{figure}[!tb]
	\includegraphics[width=.5\linewidth]{Schuitema_Fig1}
	\centering
...
%fig.2
 \begin{figure}[]
		\includegraphics[width=.5\linewidth]{Schuitema_Fig2}
...
%fig.3
 \begin{figure}[]
	\includegraphics[width=.5\linewidth]{Schuitema_Fig3}
	\centering
...
%fig.7
\begin{figure}[]
	\includegraphics[width=.5\linewidth]{Schuitema_Fig7}
