...
\def\bioone{Graduate Archaeologist at Leiden University; Specializations: Near Eastern Archaeology, Botany, Osteoarchaeology; https://leidenuni.academia.edu/VallettaVerezen;	http://www.linkedin.com/in/vallettaverezen}
...
This site lies adjacent to the Sharah Mountains and is located 265 kilometres South of Amman, Jordan’s capital city.
...
However, so far only three of the approximately 2000 monuments in Petra have been subjected to sandstone conservation\footnote{The extent to which conservation work can be conducted in Petra is highly dependent on the financial support from global funding agencies such as USAID \parencite[273--275]{balaawi2011}.} to prevent further decay \parencite[267-284]{balaawi2011}.
...
Additionally, three possible hazardous natural features were selected in order to provide examples of the possible safety-risks in the Petra Archaeological Park \cref{fig:29-Verezen-figure02,tab:Verezen-table2}.
...
Additionally, more remotely located monuments were explored such as: the Triclinium, the Roman Soldier Tomb, the Turkmanniye Tomb, and various numbered tombs such as the collapsed Tomb 609 \cref{fig:29-Verezen-figure-appendix02,fig:29-Verezen-figure01}.
...
archaeology resulting from irresponsible tourist behaviour, such as illicit climbing activities \parencite[90]{Mustafa and Abu-Tayeh 2011}. %NOTE: Reference missing from references list!
...
The most recent example is Tomb 609 with the collapse of its façade \cref{fig:29-Verezen-figure01} after heavy rainfall in March 2010,
...
This \IJSRAsubsection{The Monastery’s Urn} monument has the largest façade\footnote{The Monastery’s façade measures roughly 50 meters in width and 45 meters in height. The urn-like top is about 9.5 meters high \parencites[117--121]{maqsood 1994}[129--130]{alshawabkehy2010}.}  in Petra and is known as the Monastery \parencite[117--121]{maqsood1994}.
The focus, regarding degradation, for this case-study was on the sculpted urn, which tops the monument.
Not observable from the front-view, is the severe deterioration of its South-East side \cref{fig:29-Verezen-figure01}.
...
The \IJSRAsubsection{Treasury’s Boulder} first selection was a significant sandstone boulder stuck between a wedge-shaped fissure located to the upper-right side of the Treasury \cref{fig:29-Verezen-figure02}.
...
Steel safety nets could be installed to catch falling debris upon collapse, because ignoring this risk could otherwise threaten the park’s safety and the Treasury’s façade \parencite[2617--2639]{volkwein2010}.
...
This force was observed during a field survey in the winter of 2014, when a rapidly formed flash-flood transported and deposited an ancient basalt grinder \cref{fig:29-Verezen-figure03} and various large boulders.
...
which killed more than 20 French tourists \parencites[55--57]{comer2012}[55]{lingis2002}.
...
such as steel-nets \cref{fig:29-Verezen-figure04}, which retain falling debris during rock-falls \parencite[2638]{volkwein2011}.
The Al-Habis boulder and the Treasury’s boulder \cref{fig:29-Verezen-figure02} are proofs of the silent, and often unnoticed,
...
As well, installing steel-safety nets (fig. 4) will contribute to the park’s safety in case of
...
damage can be reduced and prevented \parencites[127]{alshawabkehy2010}[441--446]{Delmonaco et al. in Margottini et al. 2013}. %Delmonaco reference is missing
