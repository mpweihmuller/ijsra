...
%FIGURE 03: Section plan
	\includegraphics[width=1.5\linewidth]{Lakshminarayanan_Figure_03}
...
\begin{wrapfigure}{O}[3cm]{0.5\textwidth}
	\includegraphics[width=.7\linewidth]{Lakshminarayanan_Figure_08}
...
\end{minipage}\par
\subcaptionbox{\label{fig:Lakshminarayanan_Figure_12}}{\includegraphics[width=.48\linewidth]{Lakshminarayanan_Figure_12}}
\hfill
\subcaptionbox{\label{fig:Lakshminarayanan_Figure_13}}{\includegraphics[width=.48\linewidth]{Lakshminarayanan_Figure_13}}
...
\begin{figure}[!tb]
\subcaptionbox{Unworked carnelian fragments and finished bead\label{fig:Lakshminarayanan_Figure_14}}{\includegraphics[width=.32\linewidth]{Lakshminarayanan_Figure_14}}
\hfill
\subcaptionbox{Mauve Collar glass bead\label{fig:Lakshminarayanan_Figure_15}}{\includegraphics[width=.32\linewidth]{Lakshminarayanan_Figure_15}}
\hfill
\subcaptionbox{Carnelian bead finished\label{fig:Lakshminarayanan_Figure_16}}{\includegraphics[width=.32\linewidth]{Lakshminarayanan_Figure_16}}
...
\end{minipage}\hfill
\begin{minipage}[t]{.49\linewidth}
	\includegraphics[width=1.5\linewidth]{Lakshminarayanan_Figure_18}
...
\begin{wrapfigure}{O}[3cm]{0.7\textwidth}
