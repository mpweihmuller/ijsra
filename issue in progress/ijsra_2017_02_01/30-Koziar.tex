...
\def\cmail{author email}%--> only corresponding author
...
\def\authortwo{Camilo García}
%-------Biographical information-------------
\def\bioone{Frences Koziar is doing his research about ...}
\def\biotwo{Camilo García on the other is doing something about ....}
%------University/Institution--------------
\def\affilone{University of Toronto}
\def\affiltwo{McGill University}%<---- comment or delete if there is no second author.
