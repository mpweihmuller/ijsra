...
\begin{figure}[!tb]
	\includegraphics[width=.5\linewidth]{ICAHM_Figure_01a}
...
\begin{figure}[!tb]
	\includegraphics[width=.5\linewidth]{ICAHM_Figure_01b}
...
\begin{figure}[!tb]
	\includegraphics[width=.5\linewidth]{ICAHM_Figure_02}
...
%FIGURE 3: Bagamoyo
\begin{figure}[!tb]
	\includegraphics[width=.5\linewidth]{ICAHM_Figure_03}
