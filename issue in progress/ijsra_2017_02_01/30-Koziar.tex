...
\def\cmail{frances.koziar@alum.utoronto.ca, camilo.gomez@mail.mcgill.ca}%--> only corresponding author
...
%--------Author’s names------------
\def\authorone{Frances Koziar}
\def\authortwo{Camilo Gomez}
%-------Biographical information-------------
\def\bioone{Frences Koziar is a final-year master’s student in the Department of Anthropology at McGill University. She is an Aztec archaeologist and her current research analyzes the Aztec practice of human sacrifice and its place within Aztec life, religion, and Aztec views of death and personhood. More broadly she engages with the themes and subfields of the archaeology of death, grief theory, cannibalism, sacrifice, the anthropology of religion and “extreme” religions, religious discrimination, racism, colonialism, emotion and experience, and ancient states and empires. She is also a published author.}
\def\biotwo{\href{http://www.mcgill.ca/standd/camilo-gc}{Camilo Gomez} has a MA in Anthropology from McGill University and a BA from the Universidad de Los Andes, Colombia. He is now a second year P.hD. student in the Department of Anthropology at McGill University. His interests include: Latin american Archeology, Anthropology of religion, governmentality, power and counterpower, critical theory, indigenous and social movements, resistance and rebellion, human rights, Latin America and Cybernetics.}
%------University/Institution--------------
\def\affilone{University of Toronto}
\def\affiltwo{McGill University}
...
@book{Restall2003,
	...
	author = {Restall, M.},
	title = {Seven myths of the Spanish conquestn},
	year = {2003},
}
...
In order for Humboldt to study the statue of Coatlicue, it had to be dug up from where it had been buried in the basement of the University of Mexico for protection and to prevent its use in the independence movement of the time \parencites[85]{Bernal1980}[10]{Matos1979}[20]{Matos1995}.
...
\IJSRAsection{{The Revolution and the {Indigenismo} Movement}}
...
\def\keywords{México, Arqueología mexicana, colonialismo, nacionalismo, racismo, indigenismo, Indio, indígena, asimilación, mestizo, turismo arqueológico} %keywords in spanish is: "Palabras Clave"

\def\abstract{
\foreignlanguage{spanish}{La mayoría\marginnote{Abstract} de los trabajos publicados sobre la historia de la arqueología mexicana están en español, y la mayoría de los artículos científicos se han centrado en la década de los 90 y en adelante. Esta publicación presenta un resumen conciso en inglés sobre los orígenes y desarrollo de la práctica arqueológica en relación al contexto político cambiante de México desde el siglo XVI hasta nuestros días. En particular, nos centramos en los siguientes temas: la conceptualización colonial de los ‘indios’ y la conversión al Cristianismo; el nacimiento del coleccionismo anticuario en el siglo XVIII, así como el rol de Manuel Gamio en la concepción de la arqueología como práctica científica; la Revolución de los años 10 del siglo XX y el movimiento indigenista, concluyendo con reflexiones sobre el turismo arqueológico, el estatus de las poblaciones indígenas mexicanas, y la relación entre la arqueología y el estado mexicano.
La ‘arqueología’ se define aquí como el estudio del pasado (de la humanidad) a través de restos materiales, un ‘arqueólogo’ como un practicante de esta disciplina, una ‘práctica’ como la aplicación de ciertas ideas y metodologías, y, por último, una ‘disciplina’ como una rama de conocimiento enseñada en un sistema de escolarización. Consideramos que la práctica y la disciplina arqueológica en México central se desarrolló de manera paralela al nacionalismo mexicano, en periodos durante los cuales el pasado precolombino, particularmente el Imperio Azteca o Mexica era visto de manera positiva, coincidiendo con la consolidación de la corriente indigenista y la concepción de México como una nación ‘\textit{mestiza}’.}}%<--- redefine the name “Keywords“ in needed language
