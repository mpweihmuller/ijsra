...
%Fig 7
\begin{figure}[!p]
	\includegraphics[width=\linewidth]{Husemann_Figure_7}
	\caption{Map of survey area within property boundary 
		{\normalfont\scriptsize \\ \copyright\ by Bradley Husemann
			%\shortauthor
			% or NAME OF COPYRIGHT HOLDER
	}}
	\label{fig:Husemann_Figure_7}
\end{figure}

%Fig 8
\begin{figure}[!p]
	\includegraphics[width=\linewidth]{Husemann_Figure_8}
	...
	\label{fig:Husemann_Figure_8}
\end{figure}

%Fig 9
\begin{figure}[!p]
	\includegraphics[width=\linewidth]{Husemann_Figure_9}
